              ...
              return (
                <div className="slate-detail-channels">
                  ...
                  {expandedShow.instagramUrl && (
                    <a className="slate-detail-channel-btn" href={expandedShow.instagramUrl} target="_blank" rel="noopener noreferrer" aria-label="Instagram" onClick={(e) => { e.stopPropagation(); trackEvent("show_instagram", { show_id: expandedShow.id, show_title: expandedShow.title }).catch(() => {}); }}>
